...
Hours (0 to 24):<input type="text" name="hr" value="<?php echo $hr; ?>"/>
<br/><br/>
Minutes (0 to 60):<input type="text" name="min" value="<?php echo $min; ?>"/>
<br/><br/>
Day (DD):<input type="text" name="day" value="<?php echo $day; ?>"/>
<br/><br/>
Month (MM): <input type="text" name="month" value="<?php echo $month; ?>"/>
<br/><br/>
Year (YYYY): <input type="text" name="year" value="<?php echo $year; ?>"/>
<br/><br/>
Select Category:
...
<br/><br/>
cron email:<input type="text" name="cron_email" value="<?php echo $cron_email; ?>"/>
<br/><br/>
...
<br/><br/>
cron sms number:<input type="text" name="cron_sms_number" value="<?php echo $cron_sms_number; ?>"/>
<br/><br/>
